          ...
          <div>
            <form action="editsuabc.php?SpID=<?php echo $SpID; ?>" method="post">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="inventory_quantity" class="form-control"
                    value="<?php echo $inventory_quantity; ?>" readonly>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="sold_quantity" class="form-control" value="<?php echo $sold_quantity; ?>"
                    readonly>
                </div>
              </div>
