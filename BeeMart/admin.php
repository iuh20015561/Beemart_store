...
<body>
  <header class="header">
    <div class="header-left">
      <h2>Bee Mart</h2>
      <button class="dudoan" id="taobaocao"><a href="taobaocao.php">Tạo báo cáo</a></button>
      <button class="dudoan" id="dudoan">Dự đoán</button>
    </div>
          ...
          <tr>
            ...
            <td>
              <select name="chonCompany" onchange="autoMaSanPham(this.value)">
                <script>
                var company = ["Apple", "Samsung", "Oppo", "Nokia", "Huawei", "Xiaomi", "Realme", "Vivo", "Philips",
                  "Mobell", "Mobiistar", "Itel", "Coolpad", "HTC", "Motorola"
                ];
