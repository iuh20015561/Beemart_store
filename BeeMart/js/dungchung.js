...
function themVaoGioHang(masp, tensp) {
  ...
  if (!user) {
    alert("Quý khách cần đăng nhập để mua hàng !");
    showTaiKhoan(true);
    return;
  }
  if (user.off) {
    alert("Tài khoản của Quý khách hiện đang bị khóa nên không thể mua hàng!");
    addAlertBox("Tài khoản của Quý khách đã bị khóa bởi Admin.", "#aa0000", "#fff", 10000);
    return;
  }
  var t = new Date();
...
function logIn(form) {
  ...
  for (var ad of adminInfo) {
    if (equalUser(newUser, ad)) {
      alert("Xin chào admin của beemart ");
...
function signUp(form) {
  ...
  let check = true;
  // Validation: Check if ho and ten do not contain numbers
  if (containsNumbers(ho)) {
    errorHo.innerText = ("Họ không hợp lệ!");
    check = false;
  }else{
    errorHo.innerText = ("");
  }
  if (containsNumbers(ten)) {
    errorTen.innerText = ("Tên không hợp lệ!");
    check =  false;
  }else{
    errorTen.innerText = ("");
  }
  ...
  if (!validateEmail(email)) {
    errorEmail.innerText = ("Email không hơp le!");
    check = false;
  }else{
  ...
  alert("Đăng kí thành công, Quý khách sẽ được tự động đăng nhập!");
  location.reload();
                    ...
                    <form onsubmit="return signUp(this);">
                        <div class="top-row">
                            <div class="field-wrap">
                                ...
                                <span style="color: red; font-size: 12px" id="errorHo"></span>
                            </div>
                            ...
                            <div class="field-wrap">
                                ...
                                <span style="color: red; font-size: 12px" id="errorTen"></span>
                            </div>
                        </div> <!-- / ho ten -->
                        ...
                        <div class="field-wrap">
                            ...
                            <span style="color: red; font-size: 12px" id="errorEmail"></span>
                        </div> <!-- /email -->
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                ...
                <li>Thanh toán an toàn và đơn giản</li>
                <li>Dịch vụ chất lượng</li>
                <li>1 đổi 1 khi sản phẩm bị lỗi</li>
                <li>Hỗ trợ mọi lúc.
                    <br>Hotline:
                    <a href="tel:12345678" style="color: #288ad6;">123456789.</a>
                </li>
            </ul>
        </section>
    </div>`);
