    ...
    <header class="header">
        ...
        <div class="col-md-6">
            ...
            <form action="xulybc.php" method="post">
                ...
                <!-- Tháng bán hàng <input type="text" name="selling_month" class="form-control"> -->
...
$(document).ready(function(){
    // Attach a function to the change event of the product code input field
    $('input[name="product_code"]').on('change', function(){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(jsonData.success){
                    // Populate the other fields with the fetched data
                    ...
                    // Enable the "Tạo báo cáo" button
                    $('input[type="submit"]').prop('disabled', false);
                } else {
                    // Display an error message if the product code doesn't exist
                    alert('Mã sản phẩm không tồn tại. Vui lòng nhập lại.');

                    // Disable the "Tạo báo cáo" button
                    $('input[type="submit"]').prop('disabled', true);

                    // You may also choose to clear the other fields here
                }
            }
        });
    });
